...
<html lang="en">
  ...
  <body>
  <!-- ///////////////////// Navigation ///////////////////// -->
    <nav class="navbar navbar-inverse navbar-fixed-top custom-nav navbar-fixed-top" role="navigation">
        <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row promotions-row">
	                    <div class="col-md-3 col-sm-6">
                            <a href="promotion-item-2.php"><img src="img/S__12181514.jpg" class="img-responsive"></a>
                            <p>Collagen Reboot</p>
                            <p><a href="promotion-item-2.php">Read more</a> </p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="promotion-item.php"><img src="img/S__12181513.jpg" class="img-responsive"></a>
                            <!-- <div style="width: 262.5px;height:195px;"></div> -->
                            <p>โปรสุดคุ้ม โค้งสุดท้ายกระตุ้นยอดขายเหมือนแจกฟรี.</p>
                            <p><a href="promotion-item.php">Read more</a> </p>
                        </div>
