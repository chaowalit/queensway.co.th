            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Collagen Reboot</li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 promotion-detail">
                    <h3>Collagen Reboot</h3>
                    <div class="col-md-6"><img src="img/S__12181514.jpg" class="img-responsive"></div>
                    <div class="col-md-6">


                        <p>Reboot Collagen ให้กลับคืนด้วยวิตามินรวมสูตรโฮมิโอพาธี ฉีดวิตามินกระตุ่นคอลลาเจนลดอาการผิวแพ้ง่าย เซลล์ผิวไม่แข็งแรง โดยฉีด 11 จุด ฝังเข็ม เพื่อกระตุ้นให้เซลล์ผิวกลับมาทำงานได้อย่างมีประสิทธิภาพเหมือนผิวเด็ก

                    </p>
                        <p>
	                        ฉีดสัปดาห์ละ 1 ครั้ง ต่อเนื่องกัน 5-10 สัปดาห์ (ขึ้นกับสภาพผิว)
                        </p>
                        <p>
	                        รายครั้ง ครั้งละ 15,000 บาท <br/>
	                        คอร์ส 5 ครั้ง  65,000 บาท <br/>
	                        คอร์ส 10 ครั้ง  100,000 บาท
